...
export function VerifyForm() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      if (isPasswordReset) {
        // Then we have to go to new password page
        router.push("/auth/new-password");
      } else {
        // other wise remove it from session storage
        sessionStorage.removeItem("isPasswordReset");

        // and call the welcome email
        await fetch("/api", {
          method: "POST",
          headers: {
...
// business@devmanar.com
// re_7dnjU1Nc_EwNBLGUXPHvKAkznmnCY1BtZ
// supabase_auth
